...
- [ ] **Step 3: Add the narrow interface and memory implementation**
...
- [ ] **Step 5: Run the focused DB tests and verify success**
...
- `EvidenceService.exportXlsx(access: Access, input: EvidenceExportInput): Buffer`.
...
- [ ] **Step 3: Implement access-scoped summary aggregation**
...
- [ ] **Step 4: Implement status and detail filtering**
...
- [ ] **Step 5: Register the new GET routes**
...
- [ ] **Step 6: Run API service and route tests**
...
- [ ] **Step 7: Commit the protected read endpoints**
...
- [ ] **Step 3: Implement workbook generation and audit metadata**
...
**Interfaces:**
- Add Web types matching the API DTOs: `PaymentEvidenceEmployee`, `PaymentEvidenceDetail`, `PaymentEvidenceRow`, `PaymentEvidenceFilters`, and `PaymentEvidenceStatus`.
...
- [ ] **Step 4: Implement the employee list view**
...
- [ ] **Step 5: Implement employee detail and filters**
...
- [ ] **Step 6: Implement Excel field modal and download**
...
- [ ] **Step 7: Add focused admin CSS only**
...
- [ ] **Step 8: Run the focused Web test and verify success**

Run: `pnpm --filter @salary/web test -- EvidenceCenter.test.tsx`  
Expected: PASS for list/detail/filter/export interactions and empty/error states.

- [ ] **Step 9: Commit the Web feature**
...
- The old raw-event route remains covered independently; App smoke tests mock `/v1/payment-evidence/employees` and detail responses.

- [ ] **Step 1: Update failing smoke mocks**

Change the existing empty and non-empty evidence smoke tests to return employee-list responses and assert the visible active tab, employee identity, and detail action. Keep a raw API test assertion for `GET /v1/payment-evidence` unchanged.

- [ ] **Step 2: Run the Web suite and verify the updated smoke tests**
...
- [ ] **Step 4: Review and commit any scoped verification fix**
